...
import { AdminLeave, AdminManageTimesheet, Attendance, DecisionMaking, Holiday, Profile, Timesheet } from 'src/providers/constants';
...
const routes: Routes = [
  ...
  { path: DecisionMaking, component: DecisionMakingComponent},
];
